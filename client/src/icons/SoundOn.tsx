export const SoundOn = ({ size = 24, color = "#000000" }) => {
  return (
    <svg
      fill={color}
      height={size}
    ...
    >
      <g clipPath="url(#clip0_4418_8018)">
        <path
